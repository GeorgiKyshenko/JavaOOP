...
public class PetStoreTests {
    ...
    @Test
    public void test_findAllAnimalsWithMaxKgs_Should_Return_EmptyList_WithNoAnimals() {
        petStore.addAnimal(animal);
    ...
    @Test
    public void test_findAllAnimalsWithMaxKgs_Should_Return_TheHeavierSpecie() {
        petStore.addAnimal(animal);
    ...
    public void test_AddAnimal_ShouldThrowError_WhenNull() {
        petStore.addAnimal(null);
    }

    @Test
    public void test_AddAnimal_ShouldIncrease() {
        petStore.addAnimal(animal);
        assertEquals(1, petStore.getCount());
    }
    ...
    @Test
    public void test_FindAllAnimalBySpecie_ShouldReturn_EmptyList_WithNoAnimals() {
