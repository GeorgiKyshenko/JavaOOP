...
public class ControllerImpl implements Controller {
    ...
    public String addPlayer(String fieldName, String playerType, String playerName, String nationality, int strength) {
        ...
        boolean suitableFieldForWomen = fieldType.equals("ArtificialTurf") && playerType.equals("Women");
        boolean suitableFieldForMen = fieldType.equals("NaturalGrass") && playerType.equals("Men");

        if (suitableFieldForMen || suitableFieldForWomen) {
